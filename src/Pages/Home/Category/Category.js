        ...
        <div>
            <div className="max-w-xs rounded-md ml-8 mt-10 shadow-md bg-stone-300 dark:text-gray-100">
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    ...
                    <button onClick={() => handleOneCategory("1")}  type="button" className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md bg-orange-600 dark:text-gray-900">See All Products</button>
                </div>
            </div>
        </div>
    );
